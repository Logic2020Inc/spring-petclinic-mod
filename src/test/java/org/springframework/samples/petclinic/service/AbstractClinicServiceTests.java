 ...
 * @author Sam Brannen
 * @author Michael Isvy
 * @author (modified by) Michael Ashby, minor changes to method signatures to make compatible with Simple-Spring-Memcached (SSM). 
 */
public abstract class AbstractClinicServiceTests {
    ...
    public void updateOwner() throws Exception {
        ...
        this.clinicService.saveOwner(o1, o1.getId());
	...
	public void insertPet() {
	    ...
	    this.clinicService.saveOwner(owner6, owner6.getId());
